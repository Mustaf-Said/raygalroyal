const so = {
  ...
  resetPassword: "Dib u deji password-ka",
  checkEmailMessage: "Haddii akoon jiro, iimayl dib-u-dejin password ayaa la diray.",
  newPassword: "Password cusub",
  confirmPassword: "Xaqiiji password-ka",
  passwordsDoNotMatch: "Passwords-ku isma laha.",
  passwordUpdated: "Password-kaaga waa la cusboonaysiiyay.",
  invalidResetLink: "Linkiga dib-u-dejinta waa khaldan yahay ama wuu dhacay.",
  backToLogin: "Ku noqo login-ka",
  checkingResetLink: "Waa la hubinayaa linkiga dib-u-dejinta...",
  hero: {
  ...
  domainSearch: {
    ...
    buy: "Iibso",
    makeOffer: "Dalab samee",
    invalid: "Fadlan geli magac domain sax ah.",
    cartTitle: "Kolaygaaga",
    cartEmpty: "Dooro domain la heli karo si aad ugu darto kolayga.",
    domainLabel: "Domain",
    priceLabel: "Qiimaha",
    continue: "Checkout",
    ...
    addOnDns: "Maareynta DNS",
    addOnVpn: "VPN",
    priceAvailableAtRegistrar: "Qiimaha waxa laga heli karaa diiwaan-hayaha",
    totalLabel: "Wadarta",
    ...
    loadingTitle: "Waxa la baarayaa xulashooyinka loogu talagalay",
    loadingDescription: "Waxaan isbarbar dhigaynaa helitaan, qiimeyn, iyo beddelaadyo waqtiga-dhabta ah. Kuwa ugu fiican halkan ayay goor dhow kasoo muuqan doonaan.",
    loadingStepLabel: "Tallaabo",
    loadingStepLiveAvailability: "Helitaan toos ah",
    loadingStepPriceChecks: "Hubinta qiimaha",
    loadingStepAiSuggestions: "Talooyinka AI",
  },
  services: {
    title: "Adeegyadayada",
