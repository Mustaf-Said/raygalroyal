const en = {
  ...
  checkEmailMessage: "If an account exists, a password reset email has been sent.",
  ...
  domainSearch: {
    ...
    addOnSsl: "SSL Certificate",
    addOnHosting: "Web Hosting",
    addOnEmail: "Business Email",
    addOnDns: "DNS Management",
    addOnVpn: "VPN",
    priceAvailableAtRegistrar: "Price available at registrar",
    totalLabel: "Total",
    ...
    loadingTitle: "Scanning options for",
    loadingDescription: "Comparing availability, pricing, and alternatives in real time. The best matches will appear here in a moment.",
    loadingStepLabel: "Step",
    loadingStepLiveAvailability: "Live availability",
    loadingStepPriceChecks: "Price checks",
    loadingStepAiSuggestions: "AI suggestions",
  },
  services: {
    title: "Our Services",
